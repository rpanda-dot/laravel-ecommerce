                        ...
                        <div class="aa-product-catg-body">
                            <ul class="aa-product-catg">
                                ...
                                @foreach ($products as $product)
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="#"><img height="300" width="250"
                                                    src="{{ !empty($product->product_images) ? url('uploads/product_images/' . $product->product_images[0]) : url('uploads/product_images/no-product-image.png') }}"
                                                    alt="polo shirt img"></a>
                                            <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add
                                                To Cart</a>
                                            <figcaption>
                                                <h4 class="aa-product-title"><a href="#">{{ $product->name }}</a></h4>
                                                <span class="aa-product-price">{{ $product->sale_price }}</span><span
                                                    class="aa-product-price"><del>{{ $product->price }}</del></span>
                                                <p class="aa-product-descrip">Short Desciption</p>
                                            </figcaption>
                                        </figure>
